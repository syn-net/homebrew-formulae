...
__END__
diff --git i/common/fuse_param.h w/common/fuse_param.h
index cd592a5..2043f20 100644
--- i/common/fuse_param.h
+++ w/common/fuse_param.h
@@ -70,7 +70,7 @@
  */
 #define FUSE_DEFAULT_IOSIZE                FUSE_MAX_IOSIZE

-#define FUSE_DEFAULT_DAEMON_TIMEOUT                60     /* s */
+#define FUSE_DEFAULT_DAEMON_TIMEOUT                300     /* s */
